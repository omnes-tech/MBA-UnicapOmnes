...
contract NovaTurmaMapping{
    ...
    mapping(string => uint) public presencaNumero;
    ...
    function setarNumpresenca(uint _numeroChegada, string memory _nomedoAluno) external {
    ...
    function setarNotaAluno(address _aluno, uint _nota) external{

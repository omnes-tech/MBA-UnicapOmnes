...
contract GenesisDAO is ERC721A, IERC2981, ERC165, Ownable2Step, Pausable {
    ...
    constructor(
        ...
        string memory _hiddenMessage /*,bytes32 _merkleRoot*/
    ...
    function setWhitelistAndPublicSettings(
        ...
        require(
            ...
            "setWhitelistAndPublicSettings: New max supply cannot be lower than the current total supply of tokens"
        );
    ...
    function mint(uint256 _mintAmount) public payable publicSaleIsActive {
        require(
            ...
            "Mint amount exceeds max limit per wallet"
        );
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721A, ERC165, IERC165)
        returns (bool)
    {
    ...
    modifier complianceProtocol(uint256 _mintAmount) {
        ...
        require(
            msg.value >= price * _mintAmount - (((price * _mintAmount) * maxDiscount) / 10000),
